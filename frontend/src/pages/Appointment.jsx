...
const Appointment = () => {
  ...
  const { doctor, currencySymbol, backendUrl, token, getDoctorsData } = useContext(AppContext);
  ...
  const fetchDocInfo = async () => {
    const found = doctor.find(doc => doc._id === docId);
    setDocInfo(found);
  };
  ...
  const getAvailableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        const isSlotAvailable = !booked.includes(formattedTime);
